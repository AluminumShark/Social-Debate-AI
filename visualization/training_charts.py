...
class TrainingVisualizer:
    ...
    def plot_gnn_training(self, data, figsize=(16, 10)):
        ...
        fig.suptitle('GNN ', fontsize=20, fontweight='bold', y=0.98)
        
        # 1: 
        ax1 = axes[0, 0]
        ax1.plot(data['epochs'], data['losses']['delta'], 
                label='Delta ', linewidth=2.5, color=self.colors['primary'])
        ax1.plot(data['epochs'], data['losses']['quality'], 
                label='', linewidth=2.5, color=self.colors['secondary'])
        ax1.plot(data['epochs'], data['losses']['strategy'], 
                label='', linewidth=2.5, color=self.colors['accent'])
        ax1.plot(data['epochs'], data['losses']['total'], 
                label='', linewidth=3, color=self.colors['success'], linestyle='--')
        ...
        ax3.set_title(' (5)', fontsize=14, fontweight='bold')
    ...
    def plot_rl_training(self, data, figsize=(16, 10)):
        """ RL """
        fig, axes = plt.subplots(2, 2, figsize=figsize)
        fig.suptitle(' (PPO) ', fontsize=20, fontweight='bold', y=0.98)
        ...
        ax1.plot(smooth_episodes, smooth_rewards, 
                linewidth=3, color=self.colors['success'], label='')
        ...
        ax2.plot(data['episodes'], data['policy_loss'], 
                linewidth=2.5, color=self.colors['secondary'], label='')
        ax2.plot(data['episodes'], data['value_loss'], 
                linewidth=2.5, color=self.colors['accent'], label='')
        ...
        ax3.set_ylabel('', fontsize=12)
        ax3.set_title(' vs ', fontsize=14, fontweight='bold')
        ax3.grid(True, alpha=0.3)
    ...
    def plot_combined_overview(self, gnn_data, rl_data, figsize=(20, 12)):
        ...
        # 
        fig.suptitle('Social Debate AI ', fontsize=24, fontweight='bold', y=0.98)
        
        # GNN 
        ax1 = fig.add_subplot(gs[0, :2])
        ax1.plot(gnn_data['epochs'], gnn_data['losses']['total'], 
                linewidth=3, color=self.colors['primary'], label='GNN ')
        ax1.set_title('GNN ', fontsize=16, fontweight='bold')
        ...
        ax2.plot(smooth_episodes, smooth_rewards, 
                linewidth=3, color=self.colors['secondary'], label='RL ')
        ax2.set_title(' (PPO) ', fontsize=16, fontweight='bold')
        ...
        ax3.set_title('GNN ', fontsize=14, fontweight='bold')
        ax3.set_ylabel('')
        ax3.set_ylim(0, 1)
        ...
        ax4.set_title('RL ', fontsize=14, fontweight='bold')
        ax4.set_ylabel('')
        ax4.grid(True, alpha=0.3, axis='y')
        ...
        # 
        boxes = [
            {'xy': (0.1, 0.3), 'width': 0.15, 'height': 0.4, 'label': '\n', 'color': self.colors['primary']},
            {'xy': (0.3, 0.3), 'width': 0.15, 'height': 0.4, 'label': 'GNN\n', 'color': self.colors['secondary']},
            {'xy': (0.5, 0.3), 'width': 0.15, 'height': 0.4, 'label': '\n', 'color': self.colors['accent']},
        ...
        ax5.set_xlim(0, 1)
        ax5.set_ylim(0, 1)
        ax5.set_title('', fontsize=16, fontweight='bold', pad=20)
